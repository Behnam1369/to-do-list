...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _taskList_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskList.js */ \"./src/taskList.js\");\n\n\n_taskList_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].prototype.toggleTask = function toggleTask(i) {\n  this.tasks[i - 1].completed = !this.tasks[i - 1].completed;\n  this.show();\n  this.save();\n};\n\n_taskList_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].prototype.clearCompletedTasks = function clearCompletedTasks() {\n  this.tasks = this.tasks.filter((el) => el.completed === false);\n  this.reorderTasks();\n  this.show();\n  this.save();\n};\n\n\n//# sourceURL=webpack://webpack-demo/./src/interaction.js?");
